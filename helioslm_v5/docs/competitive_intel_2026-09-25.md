...
`glm53_raw_claims_2026-09-25.csv` 為二手聚合來源的 GLM-5.3 claim 原始表，其中：

| CSV 原始值 | 修正後（AA 官方） | 狀態 |
|---|---|---|
| GDPVal-AA v2 1769 Elo 排名第一 | 1655±15，第 8 名（Fable 5.1 1764、Opus 5 1735 在前） | 錯（舊快照/轉載失真） |
| GPQA Diamond 62.5%（對照 Hy4 92.3） | 協議不同不可比；且 AA v4.2 已退役 GPQA Diamond | 不可比，勿當真 |
| Terminal-Bench 3.0 88.3%（對照 Hy4 的 2.1 版 85.4%） | 版本較新不能直接比 | 版本差異 |
| Arena Elo 1474（95.7 percentile） | 與 LMArena 抓取一致 | 一致 |
